...
(http.request.uri.path contains "bsh.servlet.BshServlet") or
(http.request.uri.path contains "id_rsa") or
(http.request.uri.path contains "seeyon/htmlofficeser") or
(http.request.uri.path contains "seeyon/test123456.jsp") or
